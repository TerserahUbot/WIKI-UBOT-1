...
async def lastname(steal):
    ...
    if message.sender.bot:
        ...
        return
    await steal.edit("LU SIAPA SI CIL, GANTI NAMA MELULU DH, GA SENENG PC!!.")
    try:
        async with bot.conversation(chat) as conv:
            ...
            if response.text.startswith("No records") or r.text.startswith(
                ...
                await steal.edit("```Masa Gua Gak Nemu Riwayat Namanya si bocil, Wah si bocah belom pernah ganti nama kayak nya su!!```")
                await steal.client.delete_messages(
